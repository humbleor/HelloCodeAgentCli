...
[![Python Version](https://img.shields.io/badge/python-3.10+-blue.svg)](https://www.python.org/downloads/) [![License](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE)
...
**HelloAgents Code Agent CLI** 是一个基于 HelloAgents 框架开发的智能代码助手，提供类似 Claude Code/Codex/Gemini 的交互体验，专注于本地代码仓库的安全智能操作。
...
![test](./docs/quick_sort_plan.png)
![test](./docs/quick_sort_test.png)
